...
#define SENSOR_SAT_NUM      22
#define SENSOR_SAT_HDOP      23
#define SENSOR_BAT_VOLTAGE    24
#define SENSOR_BAT_PERCENT  25
...
const char SENSOR_PORT[24][15] = {"UART0_CSV", "UART1_CSV", "ADC", "I2C_0","I2C_1","COUNTER_0","COUNTER_1","MODBUS","M701_Modbus","M702_Modbus","BME280_I2C0","BME280_I2C1","BMP280_I2C0","BMP280_I2C1","SI7021_I2C0","SI7021_I2C1","CCS811_I2C0","CCS811_I2C1","GNSS_NUM","GNSS_HDOP","SHTxx_I2C0","SHTxx_I2C1","BAT_VOLT","BAT_PERCENT"};

#define SENSOR_NAME_NUM 25
const char SENSOR_NAME[25][20] = {"NONE", "CO2", "CH2O", "TVOC","PM2.5","PM10","TEMPERATURE","HUMIDITY","PRESSURE","WIND_SPD","WIND_DIR","RAIN","LUMINOSITY","SOIL_TEMP","SOIL_HUM","WATER_TEMP","WATER_TDS","WATER_LEVEL","WATER_FLOW","VOLTAGE","CURRENT","POWER","SAT_NUM","SAT_HDOP","BATTERY"};
