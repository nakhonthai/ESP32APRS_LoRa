...
#define SENSOR_PORT_NUM 26
const char SENSOR_PORT[26][15] = {"UART0_CSV", "UART1_CSV", "ADC", "I2C_0","I2C_1","COUNTER_0","COUNTER_1","LOGIC","M701_Modbus","M702_Modbus","BME280_I2C0","BME280_I2C1","BMP280_I2C0","BMP280_I2C1","SI7021_I2C0","SI7021_I2C1","CCS811_I2C0","CCS811_I2C1","GNSS_NUM","GNSS_HDOP","SHTxx_I2C0","SHTxx_I2C1","SYS_BAT","PZEM","MODBUS_16Bit","MODBUS_32Bit"};
