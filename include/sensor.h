...
#define PORT_INA219_I2C0 27
#define PORT_INA219_I2C1 28
#define PORT_MCP342x_I2C0 29
#define PORT_CPU_TEMP 30
#define PORT_ADS1115_I2C0   31
#define PORT_ADS1115_I2C1   32
#define PORT_AHT20_I2C0   33
#define PORT_AHT20_I2C1   34
#define SENSOR_PORT_NUM 34+1 // +1 for start from 0

const char SENSOR_PORT[SENSOR_PORT_NUM][15] = {"UART0_CSV", "UART1_CSV", "ADC", "I2C_0","I2C_1","COUNTER_0","COUNTER_1","LOGIC","M701_Modbus","M702_Modbus","BME280_I2C0","BME280_I2C1","BMP280_I2C0","BMP280_I2C1","SI7021_I2C0","SI7021_I2C1","CCS811_I2C0","CCS811_I2C1","GNSS_NUM","GNSS_HDOP","SHTxx_I2C0","SHTxx_I2C1","SYS_BAT","PZEM","MODBUS_16Bit","MODBUS_32Bit","DS1820_1Wire","INA219_I2C0","INA219_I2C1","MCP342x_I2C0","CPU_TEMP","ADS1115_I2C0","ADS1115_I2C1","AHT20_I2C0","AHT20_I2C1"};
