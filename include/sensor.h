...
#define SENSOR_VOLTAGE      18
#define SENSOR_CURRENT      19
#define SENSOR_POWER      20
#define SENSOR_SAT_NUM      21
#define SENSOR_SAT_HDOP      22
#define SENSOR_BAT_VOLTAGE    23
#define SENSOR_BAT_PERCENT  24
...
//#define PORT_BAT_PERCENT   23

#define SENSOR_PORT_NUM 24
const char SENSOR_PORT[24][15] = {"UART0_CSV", "UART1_CSV", "ADC", "I2C_0","I2C_1","CNT_0","CNT_1","MODBUS","M701_Modbus","M702_Modbus","BME280_I2C0","BME280_I2C1","BMP280_I2C0","BMP280_I2C1","SI7021_I2C0","SI7021_I2C1","CCS811_I2C0","CCS811_I2C1","GNSS_NUM","GNSS_HDOP","SHTxx_I2C0","SHTxx_I2C1","BAT_VOLT","BAT_PERCENT"};

#define SENSOR_NAME_NUM 24
const char SENSOR_NAME[24][20] = {"NONE", "CO2", "CH2O", "TVOC","PM2.5","PM10","TEMPERATURE","HUMIDITY","PRESSURE","WIND_SPD","WIND_DIR","RAIN","LUMINOSITY","SOIL_TEMP","SOIL_HUM","WATER_TEMP","WATER_TDS","WATER_LEVEL","VOLTAGE","CURRENT","POWER","SAT_NUM","SAT_HDOP","BATTERY"};
